...
<br><br><br>
    <div class="container">
        ...
        <div class="form-group">
            <label style="margin-left: 330px; font-family: candara; font-size: 20px;">Nama Siswa</label>
            <input type="text" class="form-control" name="namaa" style="width: 500px; margin-left: 330px;">
        </div>

        <div class="form-group">
            <label style="margin-left: 330px; font-family: candara; font-size: 20px;">Kelas</label>
            <input type="text" class="form-control" name="klss" style="width: 500px; margin-left: 330px;">
        </div>

        <div class="form-group">
            <label style="margin-left: 330px; font-family: candara; font-size: 20px;">No Absen</label>
            <input type="text" class="form-control" name="noabsen" style="width: 500px; margin-left: 330px;">
        </div>

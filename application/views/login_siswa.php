                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form action="<?php echo site_url('Homepage/aksi_login')?>" method="post">
                              ...
                              <div class="form-group">
                                  <p style="font-family: candara; font-size: 20px; margin-left: 70px; text-align: center;">Login Sebagai <a href="<?php echo site_url('Homepage/login_guru'); ?>">Guru</a>/<a href="<?php echo site_url('Homepage/login_satpam'); ?>">Satpam</a></p>
                              </div>
                            <div class="form-group">
                              <p style="font-family: candara; font-size: 20px; text-align: center;">Belum Memiliki Akun? <a href="<?php echo site_url('Homepage/regis_siswa'); ?>">Daftar Sekarang</a></p>
                            </div>
                            </form>
                        </div>
                    </div>

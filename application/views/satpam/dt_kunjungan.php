...
<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item active">
    <a class="nav-link" href="<?php echo site_url('Homepage/home_satpam'); ?>">
  ...
  <!-- Nav Item - Charts -->
  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url('Homepage/dt_kunjung_disatpam'); ?>">
            ...
            <div class="card-body">
              <div class="table-responsive">
                  <?php echo form_open('Homepage/search') ?>
                    <input type="text" style="margin-left: 1530px;" name="keyword" placeholder="search">

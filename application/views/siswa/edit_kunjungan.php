...
<div class="wrapper">
    ...
    <center>
        <p style="margin-top: -1px; font-size: 30px;">Form Edit Kunjungan</p>
    </center>
    <hr>

    <div>
        <?php foreach($kunjungan as $edit) { ?>
        <form action="<?php echo site_url('Homepage/editKunjungan'); ?>" method="POST" enctype="multipart/form-data" >
            ...
            <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="keper" value="<?php echo $edit->keperluan ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group row">

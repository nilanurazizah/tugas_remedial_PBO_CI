                ...
                <div class="col-sm-6 p-0">
                  ...
                  <div class="col-sm-6 p-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form action="<?php echo site_url('Homepage/aksi_loginn')?>" method="post">
                            ...
                            <div class="form-group">
                              <p style="font-family: candara; font-size: 20px; text-align: center;">Belum Memiliki Akun? <a href="<?php echo site_url('Homepage/regis_guru'); ?>">Daftar Sekarang</a></p>
                            </div>
                            </form>
                        </div>
                    </div>
